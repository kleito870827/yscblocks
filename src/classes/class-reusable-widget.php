 ...
 * YSC_Reusable_Widget
 */
class YSC_Reusable_Widget extends WP_Widget {
    /**
 ...
 * Register Widget
 */
function ysc_register_reusable_widget() {
    register_widget( 'YSC_Reusable_Widget' );
}
add_action( 'widgets_init', 'ysc_register_reusable_widget' );