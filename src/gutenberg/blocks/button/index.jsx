...
class ButtonBlock extends Component {
  ...
  render() {
    ...
    const { align, gap } = attributes;

    className = classnames(
      "ysc-button-wrapper",
      gap ? `ysc-button-wrapper-gap-${gap}` : false,
      align && align !== "none" ? `ysc-button-wrapper-align-${align}` : false,
      className
    );
      ...
      <Fragment>
        ...
        <div className={className}>
          <InnerBlocks
            ...
            allowedBlocks={["ysc/button-single"]}
          />
          {isSelectedBlockInRoot ? (
...
export const settings = {
  ...
  edit: compose([
    ...
    withDispatch((dispatch, ownProps) => {
      ...
      return {
        insertButtonSingle() {
          insertBlock(createBlock("ysc/button-single"), undefined, clientId);
        }
      };
    })
  ])(ButtonBlock),
