    ...
    public function register_scripts() {
        ...
        wp_localize_script( 'ysc-helper', 'yscVariables', array(
            ...
            'variants'          => array(                            
                ...
                'grid'               => array_merge( $default_variant, apply_filters( 'ysc_grid_variants', array() ) ),
                'grid_column'        => array_merge( $default_variant, apply_filters( 'ysc_grid_column_variants', array() ) ),
